...
<html lang="en">
  ...
  <body>
    <div class="wrapper">
      ...
      <!-- kiểm tra session template để hiển thị vào đây-->
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                Swal.fire({
                    ...
                    color: '#ffffff',
                    customClass: {
                        title: 'fs-4 text-white',
                        popup: 'fs-5 py-3 px-4',
    ...
    @endif
      <!-- End kiểm tra session template để hiển thị vào đây-->
        ...
        <div class="container">
          <div class="page-inner">
            ...
            >
              ...
              <div >
                <!-- Code ở đây-->
                <!--  Truyền biến template để hiển thị vào đây-->
